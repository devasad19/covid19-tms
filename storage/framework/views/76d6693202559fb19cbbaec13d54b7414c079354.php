<?php $__env->startSection('content'); ?>
        ...
        <?php echo $__env->make('backend.includes.alerts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <form method="POST" action="<?php echo e(route('admin.storePhlebotomist')); ?>">
                        <?php echo csrf_field(); ?>
                            <!-- Basic Card Example -->
...
<?php echo $__env->make('backend.app.backend_index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/covid19-tms/resources/views/backend/admin/add_phlebotomist.blade.php ENDPATH**/ ?>