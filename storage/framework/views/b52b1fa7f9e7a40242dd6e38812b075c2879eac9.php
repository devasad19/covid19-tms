...
<head>
  ...
  <link href="<?php echo e(asset('css/scrolling-nav.css')); ?>" rel="stylesheet">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    margin-top: 5px;">
          ...
          <?php if(Auth::check()): ?>
            ...
            Dashboard</a>
          <?php else: ?>
            <a href="<?php echo e(route('login')); ?>" class="d-none mr-2 d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            Login</a>
            <a href="<?php echo e(route('register')); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            Registration</a>
          <?php endif; ?>
            ...
            <div class=" row row-cols-2 p-0 justify-content-center">
              <div class="col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                <div class="district_and_division_data">
                  <h4>নমুনা পরীক্ষা</h4>
                  <h4><?php echo e($covidTestAll); ?></h4>
                </div>
              </div>
              <div class="col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                <div class="district_and_division_data">
                  <h4> শনাক্ত</h4>
                  <h4><?php echo e($covidPositive); ?></h4>
                </div>
              </div>
              <div class=" col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                <div class="district_and_division_data">
                  <h4> শনাক্তের হার %</h4>
                  <h4><?php if($covidTestAll == 0 || $covidPositive == 0): ?> 0 <?php else: ?> <?php echo e($covidTestAll / $covidPositive); ?> <?php endif; ?></h4>
                </div>
              </div>
              <div class="col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                <div class="district_and_division_data">
                  <h4> সুস্থতার হার %</h4>
                  <h4> <?php if($covidTestAll == 0 || $covidNigative == 0): ?> 0 <?php else: ?> <?php echo e($covidTestAll / $covidNigative); ?> <?php endif; ?></h4>
                </div>
              </div>
              ...
              <div class="col-12  col-lg-10 col-xl-10 justify-content-center" style="margin: 0 auto;">
                <div class=" row row-cols-2 p-0 justify-content-center">
                   ...
                   <div class="col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                    <div class="district_and_division_data">
                      <h4>Barishal</h4>
                      <h4><?php echo e($Barishal); ?></h4>
                    </div>
                  </div>
                   <div class="col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                    <div class="district_and_division_data">
                      <h4>Chattogram</h4>
                      <h4><?php echo e($Chattogram); ?></h4>
                    </div>
                  </div>
                  <div class=" col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                    <div class="district_and_division_data">
                      <h4>Dhaka</h4>
                      <h4><?php echo e($Dhaka); ?></h4>
                    </div>
                  </div>
                  <div class="col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                    <div class="district_and_division_data">
                      <h4>Khulna</h4>
                      <h4><?php echo e($Khulna); ?></h4>
                    </div>
                  </div>
                  <div class="col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                    <div class="district_and_division_data">
                      <h4>Rajshahi</h4>
                      <h4><?php echo e($Rajshahi); ?></h4>
                    </div>
                  </div>
                  <div class="col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                    <div class="district_and_division_data">
                      <h4>Rangpur</h4>
                      <h4><?php echo e($Rangpur); ?></h4>
                    </div>
                  </div>
                  <div class="col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                    <div class="district_and_division_data">
                      <h4>Mymensingh</h4>
                      <h4><?php echo e($Mymensingh); ?></h4>
                    </div>
                  </div>
                  <div class="col-6 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                    <div class="district_and_division_data">
                      <h4>Sylhet</h4>
                      <h4><?php echo e($Sylhet); ?></h4>
                    </div>
                  </div> 
                ...
                <div class=" row row-cols-2 p-0 justify-content-center">
                   ...
                   <div class="col-4 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                    <div class="district_and_division_data2">
                      <img src="<?php echo e(asset('images/step1.png')); ?>">
                   ...
                   <div class="col-4 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                    <div class="district_and_division_data2">
                      <img src="<?php echo e(asset('images/step2.png')); ?>">
                   ...
                   <div class="col-4 col-md-4   d_&amp;_d my-2   justify-content-center text-center">
                    <div class="district_and_division_data2">
                      <img src="<?php echo e(asset('images/step3.png')); ?>">
...
<?php /**PATH /opt/lampp/htdocs/covid19-tms/resources/views/front_index.blade.php ENDPATH**/ ?>